...
torch.save(backbone, "../model/pretrained_a/pretraining1.ckpt")
#%%
#fit 
...
torch.save(backbone2, "../model/pretrained_a/pretraining2.ckpt")
...
torch.save(backbone3, "../model/pretrained_a/pretraining3.ckpt")
...
torch.save(backbone4, "../model/pretrained_a/pretraining4.ckpt")
#%%
