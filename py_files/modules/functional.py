...
def hopfield_core_forward(query,                           # type: Tensor
    ...
    while update_active_heads.any():
            ...
            if not use_separate_proj_weight:
                ...
                if torch.equal(query, key) and torch.equal(key, value) and not (
                    ...
                    if query_as_static:
                        ...
                        # print('Crucial part of code in functional')
                        # print('hello from q-functional')
                        # print(in_proj_weight[0:3,0:3])
                        print('Q:', q.shape)
                        # ADDING STUFF FOR TESTING
                        ##########################
                        _start += hopfield_dim
                    ...
                    if key_as_static:
                        ...
                        # ADDING STUFF FOR TESTING
                        # print('Crucial part of code in functional')
                        # print('hello from k-functional')
                        # print(in_proj_weight[15:18,0:3])
                        # print('W matrices:', in_proj_weight.shape)
                        # print(query)
                        # print(key)
                        # print(value)
                        # exit()
        ...
        # # ADDING STUFF FOR TESTING
        # print(' ++++++++++++++++++++++++++++++++++++++++++++++ ')
        # print(' Q and K V shapes')
        # print(q.shape, k.transpose(1, 2).shape, v.shape, attn_output_weights.shape)
        ...
        # ADDING STUFF FOR TESTING
        # print(' ++++++++++++++++++++++++++++++++++++++++++++++ ')
        # print(' Q K V and attn_output_weights shapes')
        # print(q.shape, k.transpose(1, 2).shape, v.shape, attn_output_weights.shape)
        ...
        # ADDING STUFF FOR TESTING
        # print(' ................... ')
        # # print('Xi shape:', attn_output_weights.shape)
        # print('attn_out_weight :')
        # print(attn_output_weights)
        # print('Xi :', xi)
        # print(' ................... ')
        ##########################
